...
class HomeHotSales: BaseViewController{
    ...
    func getData() -> Void {
        ...
        AlamofireNetWork.required(urlString: "/Simple_online/Hot_sales_ranking", method: .post, parameters: ["cStoreNo":UserStoreManager.sharedManager.getStoreNo()], success: { (result) in
...
extension HomeHotSales:UITableViewDelegate, UITableViewDataSource {
