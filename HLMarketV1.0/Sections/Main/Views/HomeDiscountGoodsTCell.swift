//
//  HomeDiscountGoodsTCell.swift
//  HLMarketV1.0
//
//  Created by 彭仁帅 on 2017/6/27.
...
class HomeDiscountGoodsTCell: UITableViewCell {
    ...
    @IBAction func addShopCartBtnAction(_ sender: Any) {
        ...
        AlamofireNetWork.required(urlString: "/Simple_online/PF_Upload_Shop_cart", method: .post, parameters: ["UserNo": userNo, "cGoodsNo": self.goodsmodel!.cGoodsNo, "cStoreNo":UserStoreManager.sharedManager.getStoreNo(),"Num":"1"], success: { (result) in
