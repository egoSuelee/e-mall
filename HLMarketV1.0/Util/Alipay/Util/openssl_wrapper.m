...
NSString *base64StringFromData(NSData *signature)
{
    ...
    int signatureLength = (unsigned int)[signature length];
...
{
    int stringLength = (unsigned int)[base64String length];
...
NSString *rsaSignString(NSString *stringToSign, NSString *privateKeyFilePath, BOOL *signSuccess)
{
    ...
    int messageLength = (unsigned int)strlen(message);
...
void rsaVerifyString(NSString *stringToVerify, NSString *signature, NSString *publicKeyFilePath, BOOL *verifySuccess)
{
    ...
    int messageLength = (unsigned int)[stringToVerify lengthOfBytesUsingEncoding:NSUTF8StringEncoding];
...
{    
    ...
    int len = (unsigned int)[trimmedString length];
